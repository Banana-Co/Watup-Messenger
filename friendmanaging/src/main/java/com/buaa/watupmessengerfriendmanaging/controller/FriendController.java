...
public class FriendController {
    ...
    public ResponseEntity<Object> getFriendRequest(@RequestHeader(name = "Authorization") String token) {
        return friendService.getFriendRequest(token);
    }
    ...
    public ResponseEntity<Object> deleteFriend(@RequestHeader(name = "Authorization") String token, @RequestParam String id) {
    ...
    public ResponseEntity<Object> modifyFriendNickname(@RequestHeader(name = "Authorization") String token
            , @RequestParam String id
    ...
    public ResponseEntity<Object> blockFriend(@RequestHeader(name = "Authorization") String token, @RequestParam String id) {
        return friendService.blockFriend(token, id);
    }

    @RequestMapping(value = "friend/block", method = RequestMethod.DELETE)
    public ResponseEntity<Object> unblockFriend(@RequestHeader(name = "Authorization") String token, @RequestParam String id) {
    ...
    public ResponseEntity<Object> isFriend(@RequestHeader(name = "Authorization") String token, @RequestParam String id) {
        return friendService.isFriend(token, id);
    }

    @RequestMapping(value = "friend/block", method = RequestMethod.GET)
    public ResponseEntity<Object> isBlock(@RequestHeader(name = "Authorization") String token, @RequestParam String id) {
        return friendService.isBlock(token, id);
    }

    //仅用于测试
    @RequestMapping(value = "user", method = RequestMethod.POST)
    public ResponseEntity<Object> addUser(@RequestHeader(name = "Authorization") String token, @RequestParam String username) {
